...
public interface IMesaDao extends CrudRepository<Mesa, Long> {
    ...
    @Query(value = """
        select a.cant_voto_nulo, a.cant_voto_blanco, a.cant_voto_valido, a.cant_voto_habilitado, a.cant_voto_emitido
        from anfora a, mesa m
        where a.id_mesa = m.id_mesa and a.id_mesa = ?1
              """, nativeQuery = true)
